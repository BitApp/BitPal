...
const svgs = {
  unknown: `<path fill="#fff" style="transform:scale(0.7) translate(6px,4px)" d="M18.9,11.7c0.1-0.6,0.2-1.2,0.2-1.8c0-0.9-0.1-1.8-0.4-2.6C19.8,6.3,20.3,5.4,20,5c-0.3-0.4-1.2-0.4-2.5-0.1
